...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $file_path = '/home/pi/Documents/sx1302_hal/packet_forwarder/global_conf.json.sx1250.IN866';
    file_put_contents($file_path, $json_content);
     chmod('/etc/ppp/peers/', 755); // Make it executable (if needed)
   ...
   chmod('/etc/ppp/peers/rnet1', 644); // Read/Write for owner, Read for others
   ...
   chmod('/etc/ppp/peers/rnet1', 755); // Make it executable (if needed)
